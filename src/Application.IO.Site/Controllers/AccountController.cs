...
using Application.IO.Site.Models.AccountViewModels;
...
namespace Application.IO.Site.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(
            ...
            ILogger<AccountController> logger, IUser user) : base(user)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            #region VALIDATIONS
            //Valida campo CPF
            if (!CpfDocumentValid(model.NumDocument)) ModelState.AddModelError(string.Empty, "\"CPF\" Inválido");
            if (new AspNetUserSelect().GetByDocument(model.NumDocument) != null) ModelState.AddModelError(string.Empty, "\"CPF\" já consta cadastrado");
            #endregion
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            if (confirm != null) throw new ApplicationException($"Erro ao confirmar conta do Usuário com ID: \"{userId}\" - Erro: { confirm.Value }.");
